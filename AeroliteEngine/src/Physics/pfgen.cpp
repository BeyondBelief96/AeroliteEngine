...
void ParticleForceRegistry::UpdateForces(const real dt) {
...
Aerolite::ParticleDrag::ParticleDrag(real linVelDragCoef, real velSqDragCoeff) {
...
Aerolite::ParticleFriction::ParticleFriction(real frictionCoeff) {
