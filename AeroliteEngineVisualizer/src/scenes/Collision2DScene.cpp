...
void Collision2DScene::Setup() {
    ...
    auto bigBall = std::make_unique<Body2D>(bigBallShape, 100, 100, 5.0);
    auto smallBall = std::make_unique<Body2D>(smallBallShape, Graphics::Width() / 2.0, Graphics::Height() / 2.0, 0.0);
